...
if [ ! -d $CWD/u-boot ]; then
    wget https://source.denx.de/u-boot/u-boot/-/archive/v2024.01/u-boot-v2024.01.tar.gz
    tar -xvf u-boot-v2024.01.tar.gz
    mv u-boot-v2024.01 u-boot
    rm u-boot-v2024.01.tar.gz
