...
#define DECLARE_ATOMIC_1(name) \
uint64_t __atomic_fetch_##name##_1(uint64_t *ptr, int memorder) \
{	\
	return __atomic_fetch_##name(ptr, 1, memorder);	\
}

#define DECLARE_ATOMIC_2(name) \
uint64_t __atomic_fetch_##name##_2(uint64_t *ptr, int memorder) \
{	\
	return __atomic_fetch_##name(ptr, 2, memorder);	\
}

DECLARE_ATOMIC_1(add)
DECLARE_ATOMIC_1(sub)
DECLARE_ATOMIC_1(and)
DECLARE_ATOMIC_1(nand)
DECLARE_ATOMIC_1(xor)
DECLARE_ATOMIC_1(or)
DECLARE_ATOMIC_2(and)
DECLARE_ATOMIC_2(xor)
DECLARE_ATOMIC_2(or)
DECLARE_ATOMIC_2(add)
DECLARE_ATOMIC_2(nand)
DECLARE_ATOMIC_2(sub)
