...
$(platform_build_dir)/firmware/fw_dynamic.o: $(EMOD_MANAGER_BIN)
$(platform_build_dir)/firmware/fw_jump.o: $(EMOD_MANAGER_BIN)
$(platform_build_dir)/firmware/fw_payload.o: $(EMOD_MANAGER_BIN)
